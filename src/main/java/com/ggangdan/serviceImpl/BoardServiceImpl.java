...
public class BoardServiceImpl implements BoardService {
   ...
   public void insert(BoardVO vo) {
      ...
      if (file.isEmpty()) {
         ...
         String uploadFolder = "D:\\kdigital2307\\Spring\\springws\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\ggangdan\\resources\\imgs\\boardImg";
   ...
   @Override
   public List<BoardVO> getBest(int iidx) {
   ...
   public double getInvestigationRate(int iidx) {
	   return board.getInvestigationRate(iidx);
   }
